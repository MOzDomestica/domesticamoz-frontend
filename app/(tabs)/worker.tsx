...
const styles = StyleSheet.create({
  ...
  avatarText: { color: '#1F8A70', fontSize: 18, fontWeight: 'bold' },
  headerInfo: { flex: 1 },
  ...
  badgeVerificadaText: { color: '#1F8A70', fontSize: 12, fontWeight: '600' },
  ...
  tagTipoText: { color: '#1F8A70', fontSize: 13, fontWeight: '600' },
  ...
  sectionLabelGreen: { fontSize: 13, fontWeight: '600', color: '#1F8A70', marginBottom: 12 },
  ...
  radioSelecionado: { borderColor: '#1F8A70' },
